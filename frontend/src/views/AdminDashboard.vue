    ...
    <header class="admin-header">
      <div class="header-content">
        ...
        <nav class="admin-nav">
          ...
          <router-link to="/admin/coupons" class="nav-item" :class="{ active: $route.path === '/admin/coupons' }">优惠券</router-link>
          <router-link to="/admin/maintenance" class="nav-item" :class="{ active: $route.path === '/admin/maintenance' }">维护看板</router-link>
